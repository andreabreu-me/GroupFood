...
public class FacebookMapper implements ResultSetMapper<Facebook> {
    public Facebook map(int index, ResultSet r, StatementContext ctx) throws SQLException {
        ...
        return new Facebook(r.getString("id"), r.getString("userId"), r.getString("token"), r.getString("firstName"), r.getString("lastName"), r.getString("email"),r.getString("createdOn"),r.getString("updatedOn"),r.getString("deletedOn"));
    }
}