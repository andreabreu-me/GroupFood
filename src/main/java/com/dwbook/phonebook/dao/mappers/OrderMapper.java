...
public class OrderMapper implements ResultSetMapper<Order> {
    public Order map(int index, ResultSet r, StatementContext ctx) throws SQLException {
        ...
        return new Order(r.getInt("id"), r.getString("organizerId"), r.getString("name"),r.getString("description"),r.getString("deliveryAddress"), r.getFloat("deliveryLatitude"), r.getFloat("deliveryLongitude"), r.getString("status"), r.getInt("timeLimit"));
    }
}   